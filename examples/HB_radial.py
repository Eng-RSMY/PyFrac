...
# creating mesh
Mesh = CartesianMesh(0.03, 0.03, 41, 41)
...
Q0 = 3.3e-5  # injection rate
Injection = InjectionProperties(Q0, Mesh)

# fluid properties
Fluid = FluidProperties(viscosity=1, rheology='HB', n=0.75, k=1, T0=7)
...
simulProp.set_simulation_name('sheer_thining_75-1-7')
...
Fr = Fracture(Mesh,
              ...
              Injection,
              simulProp)
# Fr = load_fractures(address="./Data/HB")[0][-1]
...
Fr_list, properties = load_fractures(address="./Data/HB", sim_name='sheer_thining')        # load all fractures
...
# loading simulation results
Fr_list, properties = load_fractures(address="./Data/HB", sim_name='sheer_thining', step_size=10)        # load all fractures
time_srs = get_fracture_variable(Fr_list, variable='time')                      # list of times
#
# # plot fracture radius
